...
SECRET_KEY = 'django-insecure-o!)#1^6g8z9^0#(!eg!4sf594dupcbw1a&dqdz5xfziu0or7ff'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'core' / 'templates'], # Explicitly add the template path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
RAZORPAY_KEY_ID = 'rzp_test_SgEu94h8dbDaav'  # Your Razorpay test key
RAZORPAY_KEY_SECRET = 'keecJz4GkIFsN5ONPYWfRfDd'  # Your Razorpay test secret
